...
public class CPagerSlidingTabStrip extends HorizontalScrollView {
	...
	public CPagerSlidingTabStrip(Context context) {
		this(context, null);
	}

	public CPagerSlidingTabStrip(Context context, AttributeSet attrs) {
